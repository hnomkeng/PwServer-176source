...
void 
ai_npcobject::SummonMonster(int mod_id, int count, const XID& target, int target_distance, int remain_time, char die_with_who, int path_id, int roleid)
{
	gnpc_imp * pImp = (gnpc_imp*)_imp;
	pImp->SummonMonster(mod_id,count,target,target_distance,remain_time,die_with_who,path_id,roleid);	
}
