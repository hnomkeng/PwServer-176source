...
public:
	...
	void PlayerLinkRequest(gplayer_imp * pImp, const XID & target, int param_id);
	void PlayerLinkInvite (gplayer_imp * pImp, const XID & target, int param_id);
	void PlayerLinkReqReply(gplayer_imp * pImp, const XID & target,int param, int param_id);
	void PlayerLinkInvReply(gplayer_imp * pImp, const XID & target,int param, int param_id);
	void PlayerCancel(gplayer_imp *pImp);


	void MsgRequest(gplayer_imp * pImp, const XID & target, const void * _vmsg, unsigned int len);
	void MsgInvite (gplayer_imp * pImp, const XID & target, const void * _vmsg, unsigned int len);
