#ifndef __ONLINEGAME_GS_PLAYER_CAMPTOKEN_H__
#define __ONLINEGAME_GS_PLAYER_CAMPTOKEN_H__


class gplayer_camp_token : public gplayer_imp
{
...
public:
	DECLARE_SUBSTANCE(gplayer_camp_token);
	...
	virtual bool IsCampTokenMember(const XID& member);
