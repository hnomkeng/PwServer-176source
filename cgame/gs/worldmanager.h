...
public:
	...
	// Limitador de Dungeons
	static void RemoveLockPlayerRole(int roleid);
	static void RemoveLockPlayer(int roleid, int mapid);
	static bool AddLockPlayer(int roleid, unsigned int ip, unsigned long long hwid, int mapid);
	static bool CheckLockAccess(unsigned int ip, unsigned long long hwid, int mapid);
	static bool CheckLockAccessFromHwid(unsigned long long hwid, int mapid);
	static bool CheckLockAccess(int roleid);
	static bool CheckLockAccessNoMap(int roleid, int map_id);

	// Limitador Evento 
	static void RemoveEventLockPlayerRole(int roleid);
	static void RemoveEventLockPlayer(int roleid, int event_type);
	static bool AddEventLockPlayer(int roleid, unsigned int ip, unsigned long long hwid, int event_type);
	static bool CheckEventLockAccess(unsigned int ip, unsigned long long hwid, int event_type);
	static bool CheckEventLockAccessFromHwid(unsigned long long hwid, int event_type);
	static bool CheckEventLockAccess(int roleid);
	static bool CheckEventLockAccessNoMap(int roleid, int event_type);

	// Limitador Quest 
	static void RemoveQuestLockPlayerRole(int roleid);
	static void RemoveQuestLockPlayer(int roleid, int questid);
	static bool AddQuestLockPlayer(int roleid, unsigned int ip, unsigned long long hwid, int questid);
	static bool CheckQuestLockAccess(unsigned int ip, unsigned long long hwid, int questid);
	static bool CheckQuestLockAccessFromHwid(unsigned long long hwid, int questid);
	static bool CheckQuestLockAccess(int roleid);
	static bool CheckQuestLockAccessNoMap(int roleid, int questid);
...
//�������
	...
	virtual bool InitCampToken() { return false; }
public:
	//����pvp���
