...
itemdataman::generate_spec_addon_buffer(DATA_TYPE essencetype, char * addon_buffer, unsigned int max_addon_size, unsigned int &addon_num, int * sa_list)
{
	...
	return generate_equipment_addon_buffer_2(essencetype,sa_list,sizeof(int),i,addon_buffer,addon_num,addon_arg[0],addon_arg[1]);
}
...
unsigned int itemdataman::generate_equipment_addon_buffer
		...
		unsigned int &addon_arg1,
		unsigned int &addon_arg2)
{
	...
	addon_num = anum;
	unsigned int addon_arg[2];
	return generate_equipment_addon_buffer_2(essencetype,addon_list,sizeof(int),anum,addon_buffer,addon_num,addon_arg[0],addon_arg[1]);
}
