#ifndef __ONLINEGAME_GS_PLAYER_IMP_CAMP_PVP_H__
#define __ONLINEGAME_GS_PLAYER_IMP_CAMP_PVP_H__

#include "player_imp.h"


class gplayer_pvp_camp_imp: public gplayer_imp
{
private:
...
public:
	DECLARE_SUBSTANCE(gplayer_pvp_camp_imp);
