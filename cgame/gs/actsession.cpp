...
{
	MSG msg;
	BuildMessage(msg,message,target,source,A3DVECTOR(0.f,0.f,0.f),_session_id,0);
...
{
	MSG msg;
	BuildMessage(msg,GM_MSG_OBJ_SESSION_REPEAT,self,self,A3DVECTOR(0.f,0.f,0.f),_session_id,0);
...
{
	MSG msg;
	BuildMessage(msg,GM_MSG_OBJ_SESSION_REPEAT_FORCE,self,self,A3DVECTOR(0.f,0.f,0.f),_session_id,0);
	_plane->PostLazyMessage(msg);
}
...
{
	MSG msg;
	BuildMessage(msg,GM_MSG_OBJ_SESSION_END,self,self,A3DVECTOR(0.f,0.f,0.f),_session_id,0);
	_plane->PostLazyMessage(msg);
}
