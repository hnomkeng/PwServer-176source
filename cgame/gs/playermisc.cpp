...
/*原则4：
	...
	{
		A3DVECTOR(0.4f, 0.53f, 0.4f),	//	武侠 0
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f),	//	法师 1
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f),	//  巫师 2
		A3DVECTOR(0.3f, 0.5f, 0.3f),	

		A3DVECTOR(0.3f, 0.53f, 0.3f),	//	妖精 3
		A3DVECTOR(0.3f, 0.5f, 0.3f),	

		A3DVECTOR(0.5f, 0.62f, 0.5f), 	//	妖兽 4
		A3DVECTOR(0.3f, 0.53f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//  刺客 5
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	羽芒 6
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	羽灵 7
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	剑灵 8
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	魅灵 9
		A3DVECTOR(0.3f, 0.5f, 0.3f),
		
		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	夜影 10
		A3DVECTOR(0.3f, 0.5f, 0.3f),

		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	月仙 11
		A3DVECTOR(0.3f, 0.5f, 0.3f),
		
		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	SHOOTER
		A3DVECTOR(0.3f, 0.5f, 0.3f),
		
		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	PALADIN
		A3DVECTOR(0.3f, 0.5f, 0.3f),
		
		A3DVECTOR(0.3f, 0.53f, 0.3f), 	//	MONKY
		A3DVECTOR(0.3f, 0.5f, 0.3f),
	};
	const A3DVECTOR aExts2[USER_CLASS_COUNT*2] =
	{
		A3DVECTOR(0.4f, 0.9f, 0.4f),	//	武侠 0
		A3DVECTOR(0.3f, 0.85f, 0.3f),
 
		A3DVECTOR(0.3f, 0.9f, 0.3f),	//	法师 1
		A3DVECTOR(0.3f, 0.85f, 0.3f),

		A3DVECTOR(0.3f, 0.9f, 0.3f),	//  巫师 2
		A3DVECTOR(0.3f, 0.85f, 0.3f),	

		A3DVECTOR(0.3f, 0.9f, 0.3f),	//	妖精 3
		A3DVECTOR(0.3f, 0.85f, 0.3f),	

		A3DVECTOR(0.5f, 1.05f, 0.5f), 	//	妖兽 4
		A3DVECTOR(0.3f, 0.9f, 0.3f),

		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//  刺客 5
		A3DVECTOR(0.3f, 0.85f, 0.3f),

		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//	羽芒 6
		A3DVECTOR(0.3f, 0.85f, 0.3f),

		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//	羽灵 7
		A3DVECTOR(0.3f, 0.85f, 0.3f),
		...
		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//	SHOOTER
		A3DVECTOR(0.3f, 0.85f, 0.3f),
		
		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//	PALADIN
		A3DVECTOR(0.3f, 0.85f, 0.3f),
		
		A3DVECTOR(0.3f, 0.9f, 0.3f), 	//	MONKY
		A3DVECTOR(0.3f, 0.85f, 0.3f),
	};
