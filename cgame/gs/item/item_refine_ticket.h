#ifndef __ONLINEGAME_GS_REFINE_TICKET_H__
#define __ONLINEGAME_GS_REFINE_TICKET_H__
...
class refine_ticket_item : public item_body
{
protected:
...
public:
	DECLARE_SUBSTANCE(refine_ticket_item);

	virtual item_body* Clone() const { return new refine_ticket_item(*this); }

	virtual ITEM_TYPE GetItemType()
	{
		return ITEM_TYPE_REFINE_TICKET;
	}
private:
