...
template <typename ARG_TYPE>
class template_all_enhance_damage_2: public arg_addon<ARG_TYPE>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
...
typedef template_all_enhance_damage_2<POINT>			enhance_all_damage_addon_2;
typedef template_all_enhance_damage_2<DOUBLE_POINT>		enhance_all_damage_addon_2_2arg;
...
template <typename ARG_TYPE>
class template_enhance_all_resistance_and_defense: public arg_addon<ARG_TYPE>
{
public:
	virtual int UpdateItem(const addon_data & data, equip_item * equip)
	{
...
typedef template_enhance_all_resistance_and_defense<POINT>			enhance_all_resistance_and_defense;
typedef template_enhance_all_resistance_and_defense<DOUBLE_POINT>	enhance_all_resistance_and_defense_2arg;
...
public:
    virtual int GenerateParam(int datatype, addon_data & data,int arg_num)
    {
        ...
        ASSERT(speed >= -1 && speed <= 1.5);
        if(speed <= -1 || speed > 1.5) return -1;

        data.arg[0] = (int)(speed * 20 + 0.5);
        return 1;
    }
...
template <typename PARAM_TYPE,typename RETURN_TYPE, int OFFSET_IN_IMP,
		  typename PARAM_TYPE2,typename RETURN_TYPE2, int OFFSET_IN_IMP2,
		  typename ARGTYPE>
class APSA_addon_3: public arg_addon<ARGTYPE>		// enhance param (single arg,double prop) addon
{
public:
	virtual int UpdateItem(const addon_data & , equip_item *)
	{
	...
	virtual int Activate(const addon_data & data , equip_item * item, gactive_imp *pImp)
	{
		*(RETURN_TYPE*)((char*)pImp + OFFSET_IN_IMP) += ((RETURN_TYPE)(*(PARAM_TYPE*)&(data.arg[0])) / 2);
		*(RETURN_TYPE2*)((char*)pImp + OFFSET_IN_IMP2) += ((RETURN_TYPE2)(*(PARAM_TYPE2*)&(data.arg[0])) / 2);
		return 0;
	}
...
typedef APSA_addon_3<float, int, POINT_OFF+offsetof(enhanced_param,damage_low),
float, int, POINT_OFF+offsetof(enhanced_param,damage_high),POINT> as_enhance_damage_addon_2;
typedef APSA_addon_3<float, int, POINT_OFF+offsetof(enhanced_param,magic_dmg_low),
float, int, POINT_OFF+offsetof(enhanced_param,magic_dmg_high),POINT> as_enhance_magic_dmg_addon_2;
...
typedef EPSA_addon<int, PERCENT_OFF+offsetof(scale_enhanced_param,max_hp),DOUBLE_PERCENT> enhance_hp_addon_float;
typedef EPSA_addon<int, PERCENT_OFF+offsetof(scale_enhanced_param,max_mp),DOUBLE_PERCENT> enhance_mp_addon_float;
...
#define TEMPORARY_ADDON_MACRO(type) temporary_addon_template<type>
	...
	INSERT_CAMP_ADDON(3608,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3609,as_enhance_magic_dmg_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3615,as_enhance_magic_dmg_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3622,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3633,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3637,as_enhance_magic_dmg_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3644,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3648,as_enhance_magic_dmg_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3655,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3659,as_enhance_magic_dmg_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_CAMP_ADDON(3666,as_enhance_damage_addon_2, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3667, enhance_attack_degree, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3668, enhance_defend_degree, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	INSERT_CAMP_ADDON(3669,as_enhance_defense_addon, addon_manager::ADDON_PARAM_RATIO_ALL_FLOAT);
	...
	INSERT_ADDON(3727, enhance_all_resistance_and_defense_2arg);
	INSERT_ADDON(3728, enhance_all_damage_addon_2_2arg);
	...
	INSERT_ADDON(3734, enhance_defense_addon_2);
	...
	INSERT_ADDON(3825, enhance_hp_scale_addon);
