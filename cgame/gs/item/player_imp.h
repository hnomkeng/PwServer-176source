...
//NEW FUNCTIONS
	...
	void SendClientMsgChild(char* child_name, int child_name_len, int kid_debri_id);
	...
	void SendClientNorthKingdomProtocol();
	void IncExpNorthKingdom(int exp);
