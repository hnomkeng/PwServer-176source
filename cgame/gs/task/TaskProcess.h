...
struct ActiveTaskList
{
	...
	int GetMaxSimultaneousCount() { return m_uMaxSimultaneousCount ? EmulateSettings::GetInstance()->GetTaskExpandCount() : EmulateSettings::GetInstance()->GetTaskDefaultCount(); }
