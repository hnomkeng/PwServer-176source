...
#define TASK_MASK_EVENT_TASK			0x00000100
#define TASK_MASK_USE_ITEMS				0x00000200
...
struct TaskInterface
{
	...
	virtual unsigned int GetTaskMaskInt() = 0;
	...
	virtual int GetTeamVisibleStateParam(unsigned int ulStateId) = 0;
	...
	virtual bool CheckHwidLimit(int task_id) = 0;
	virtual void RemoveHwidLimit() = 0;
	...
	virtual bool GetTeasoureCheckRadius(int tag_id, int tag_required, float radius_size, float old_pos[3]) = 0;
	...
	virtual int GetPointsWeekArena() = 0;
	virtual int GetWinCountArena() = 0;

	virtual void UpdatePlayerEventTask(int task_id, int points) = 0;
	virtual int GetPlayerEventTask(int task_id) = 0;
	virtual void RemovePlayerEventTask(int task_id) = 0;

	virtual void UpdatePlayerUseItems(int task_id, int count) = 0;
	virtual int GetPlayerUseItems(int task_id) = 0;

	virtual unsigned int CheckHasCampTokenType() = 0;
	virtual unsigned int CheckHasCampTokenPower() = 0;
	...
	virtual void CheckEventValidTask(int task_id) = 0;
	virtual void TaskExpCelestialMemorial(int swallow_exp) = 0;
	virtual void SetAnecdotePoints() = 0;
	virtual void PassBattleTaskManager() = 0;
	virtual void PassBattleTaskAddItemPass(int itemid, int itemcount) = 0;
	...
	virtual int GetHistoryGlobalValue(int lKey) = 0;

	// Novo 
	virtual void PutPersonGlobalValue(int bChangeType, int lKey, int lValue) = 0;
	virtual int GetPersonGlobalValue(int lKey) = 0;
	...
	virtual void UpdateCampTokenScore(unsigned int lValue) = 0;
	virtual void UpdateCampTokenMoney(unsigned int lValue) = 0;
